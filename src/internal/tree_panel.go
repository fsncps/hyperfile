...
//
//nolint:unused // WIP: not yet integrated
type fileAreaFocus int

const (
	primaryPanelActive   fileAreaFocus = iota //nolint:unused // primary (left) file panel
	secondaryPanelActive                      //nolint:unused // secondary (right) file panel
)
...
const (
	secondaryModeTree   secondaryPanelMode = iota //nolint:unused // independent file tree
	secondaryModeDetail                           //nolint:unused // detail view of primary's selected dir
)
...
type treePanelModel struct {
	...
	contentQuery      string          //nolint:unused // WIP: original content search query
	contentSearchMode bool            //nolint:unused // WIP
	showRootNode      bool
}
