...
type HotkeysType struct {
	...
	SecPanelModeTree      []string `toml:"sec_panel_mode_tree" comment:"Secondary panel mode hotkeys"`
	SecPanelModeDetail    []string `toml:"sec_panel_mode_detail"`
	SecPanelModeGit       []string `toml:"sec_panel_mode_git"`
	SecPanelModeDiskUsage []string `toml:"sec_panel_mode_disk_usage"`
